 ...
 *@return 当前的请求任务。
 */
- (nullable NSURLSessionDataTask *)getBindedDeviceListWithUid:(NSString *)uid success:(nullable void(^)(NSArray<MyDevice *> *devices,NSArray *productInfoListArr))success error:(nullable void(^)(NSError *error))errorBlock failure:(nullable void(^)(NSError *error))failure;
